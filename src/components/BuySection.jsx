  ...
  return (
    <div className="bg-[#0797EB]   py-5 pb-24 mt-12 ">
      <div className="mx-9">
        ...
        <div ref={roadMapRef} className="flex lg:flex-row flex-col gap-y-16 lg:justify-between gap-3  justify-center items-center w-full">
          <BuyCard
